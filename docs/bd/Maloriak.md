...
- <b><span className="dmg-nature">Зелёная</span></b>: (15 сек) Малориак проводит неудачный эксперимент с зелёной колбой.
  Все существа на арене получают
  дебафф [изнуряющая слизь](https://www.wowhead.com/cata/ru/spell=77615), под которым получаемый урон увеличивается на
